...
<div id="cart-content" id="gio-hang-content">
    <table class="bang-gio-hang" style="width: 95%; text-align:center; margin: 0 auto; font-family: Montserrat, sans-serif; font-size:14px" border="1" border-collapse:collapse>
        ...
        <?php
        // if (isset($_SESSION['cart'])) { (NO)
        if (isset($_SESSION['cart']) && !empty($_SESSION['cart'])) {
        // if (isset($cart_to_display) && !empty($cart_to_display)) {
            $i = 0;
            $tongtien = 0;
        ...
        ?>
                <tr>
                    ...
                    <td>
                        <a href="pages/main/themgiohang.php?cong=<?php echo $cart_item['id']; ?>&redirect=giohang"><i class="fa fa-plus fa-style" aria-hidden="true"></i></a>
                        <?php echo $cart_item['soluong'] ?>
                        <a href="pages/main/themgiohang.php?tru=<?php echo $cart_item['id']; ?>&redirect=giohang"><i class="fa fa-minus fa-style" aria-hidden="true"></i></a>
                    </td>
