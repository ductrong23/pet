//  ĐIỀN ĐỦ VÀ ĐÚNG YÊU CẦU THÔNG TIN VẬN CHUYỂN => THÔNG TIN THANH TOÁN (KHÔNG ĐĂNG NHẬP)
// POP UP XUẤT HIỆN KHI CLICK NÚT THÔNG TIN THANH TOÁN / THANH TOÁN
document.addEventListener("DOMContentLoaded", function () {
  const checkoutLink3 = document.getElementById("thongtinthanhtoanoff-link3");
  const checkoutLink4 = document.getElementById("thongtinthanhtoanoff-link4");
  ...
  if (checkoutLink3) {
    checkoutLink3.addEventListener("click", handleCheckoutLink);
  }

  // Thêm sự kiện click cho link 2
  if (checkoutLink4) {
    checkoutLink4.addEventListener("click", handleCheckoutLink);
  }
